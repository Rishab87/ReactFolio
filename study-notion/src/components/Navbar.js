  ...
  return (
    <div className='flex justify-between items-center w-11/12 max-w-[1160px] py-4 mx-auto'>
        ...
        <div className='flex items-center gap-x-4'>
            { !isLoggedIn && //The expression { !isLoggedIn && ... } is a way of conditionally rendering content in JSX. The content within the curly braces ({}) will be rendered only if the expression before the && is true.
                                //interanl working of this type of conditonal statement
                <Link to="/login">
